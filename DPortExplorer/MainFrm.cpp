...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_CREATE()
	ON_COMMAND(ID_VIEW_DLG, OnViewDlg)
	//}}AFX_MSG_MAP
	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMPortExplorerView), CSize(100, 100), pContext))
	{
...
CMPortExplorerView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CMPortExplorerView* pView = DYNAMIC_DOWNCAST(CMPortExplorerView, pWnd);
	return pView;
}
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CMPortExplorerView* pView = GetRightPane(); 
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// Wenn der rechte Ausschnitt erstellt wurde und CMPortExplorerView ist,
