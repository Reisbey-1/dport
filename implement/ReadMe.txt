========================================================================
    ACTIVE TEMPLATE LIBRARY : DPort Project Overview
========================================================================

AppWizard has created this DPort project for you to use as the starting point for
...
DPort.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (DPort.h)
        GUID definitions                                (DPort_i.c)
        A type library                                  (DPort.tlb)
        Marshaling code                                 (DPort_p.c and dlldata.c)

DPort.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in DPort.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named DPort.pch and a precompiled types file named StdAfx.obj.
...
DPortps.vcproj
	...
	dlldata.c, DPort_i.c and DPort_p.c which are required
